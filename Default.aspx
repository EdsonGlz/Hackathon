        ...
        <div>
            <table>
                <tbody>
                    <tr class="contain">
                            <td>
                                <asp:ImageButton ID="ImageButton2" PostBackUrl="~/Terrenos.aspx" ImageUrl="~/Imagenes/avo.png" runat="server" style="width:90px; vertical-align:middle;"  />
     ...
     <div id="toolbox" visible="false" runat="server" class="jumbotron" style="margin-left:auto; margin-right:auto; margin-top:auto; margin-bottom:auto; align-self:center; width:70%; height:10%; background-color:#dde8f0">
         <table>
             <tr>
                 ...
                 <td>
                     <asp:ImageButton OnClick="AgregarCosecha_Click" ID="AgregarCosecha" style="margin-left:auto; margin-right:auto; margin-top:auto; margin-bottom:auto; width:40px" src="/Imagenes/ImagenCosecha.png" runat="server" />
                 </td>
                 <td>
                         ...
                         <table style="width:90%; margin-left:auto; margin-right:auto;">
                                    <tr>
                                        ...
                                        <td  style="text-align:center; align-content:center; align-items:center; margin-left:auto; margin-right:auto;">
                                            <asp:Image HorizontalAlign="Center" class="ImagenPlanta" ID="ImagenPlanta" runat="server"   ImageUrl='<%#Eval("ImagenUrl")%>'/><br /><br />
                                    ...
                                    <asp:GridView HorizontalAlign="Center" ID="GVBitacoraCosecha" OnPageIndexChanging="GVBitacoraCosecha_PageIndexChanging" PageSize= "5" allowpaging="true" style="align-content:center; align-items:center;" CssClass="mGrid" runat="server" AutoGenerateColumns = "false">
                                        <Columns>
                                            <asp:BoundField DataField="C_Super" HeaderText ="Aguacates Super" />
                                            <asp:BoundField DataField="C_Extra" HeaderText ="Aguacates Extra"  />
                                            <asp:BoundField DataField="C_Primera" HeaderText ="Aguacates Primera"  />
                                            <asp:BoundField DataField="C_Mediano" HeaderText ="Aguacates Mediano"  />
                                            <asp:BoundField DataField="C_Comercial" HeaderText ="Aguacates Comerciales"  />
                                            <asp:BoundField DataField="Fecha" HeaderText ="Fecha de Cosecha"  />
                                        </Columns>
                                    </asp:GridView>
                                    ...
                                    <tr>
                                        <td>
                                            <table style="width:90%;  margin-left:auto; margin-right:auto;">
                                                ...
                                                <tr>
                                                    <td style=" margin-left:auto; margin-right:auto; padding:inherit; text-align:center;color:#333333;font-weight:bold;">
                                                    ...
                                                    <td style=" margin-left:auto; margin-right:auto; padding:inherit; text-align:center;color:#333333;font-weight:bold;">
                                                        <asp:ImageButton type="image" CssClass="ImagenLogo" OnClick="ImagenCosecha_Click" src="Imagenes/ImagenCosecha.png" ID="ImagenCosecha" runat="server" /><br />
                                                        <asp:Label ID="Label2" runat="server" text-align="center" Text="Bitacora Cosecha"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
